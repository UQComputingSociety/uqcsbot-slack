...
from uqcsbot.utils.uq_course_utils import (get_course_profile_url, HttpException,
                                           CourseNotFoundException, ProfileNotFoundException)
...
def handle_ecp(command: Command):
    """
    `!ecp [COURSE CODE]` - Returns the link to the latest ECP for the given course code.
